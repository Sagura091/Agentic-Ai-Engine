"""
002_create_autonomous_tables.py
Production-Ready Database Migration System for Autonomous Agent Tables.

Migration Order: 002 (Second - Autonomous Agent Foundation)
Dependencies: 001_init_database.sql
Next: 003_create_auth_tables.py
...
ESSENTIAL AUTONOMOUS AGENT LEARNING TABLES (PRESERVED):
...
- agent_memories: Deep memory storage (episodic/semantic/procedural) ✅
- learning_experiences: Learning data and insights ✅

REMOVED FROM THIS MIGRATION:
- performance_metrics: System performance tracking (not learning-related)
"""
        ...
        try:
            ...
            async with self.session_factory() as session:
                async with session.begin():
                    # Drop tables in reverse dependency order (OPTIMIZED)
                    tables_to_drop = [
                        # "performance_metrics",  # REMOVED: Not created in optimized schema
